...
// switches to jsdom.
// Import and module-init safety in a non-browser runtime, plus transport fixity (the transport instance
...
/** A minimal receive-only transport with a controllable open/close, for the transport-reuse assertion. */
...
describe("transport is fixed for the client's lifetime", () => {
