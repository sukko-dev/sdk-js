// Subscription state. Tracks what the client WANTS subscribed (`desired`) versus what the
...
export class SubscriptionState {
	...
	/** Desired channels the server has not granted — the escalation re-subscribe delta. */
	notGranted(): string[] {
