// Heartbeat / liveness monitor. `SukkoClient` constructs one HeartbeatMonitor per
...
// receive-only transport (SSE), whose sole liveness detector is the SSE idle timeout. All
