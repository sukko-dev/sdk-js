...
Language-neutral scenario fixtures. Both SDKs replay the **same** JSON through their pure
state machines and must produce identical canonical action sequences — this is how cross-SDK parity is *measured* rather than asserted in prose. This repo is the **canonical** home; `sukko-py`
